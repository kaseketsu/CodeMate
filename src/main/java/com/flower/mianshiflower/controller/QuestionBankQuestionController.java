...
public class QuestionBankQuestionController {
    ...
    public BaseResponse<Boolean> removeQuestionBankQuestion(@RequestBody QuestionBankQuestionRemoveRequest removeRequest) {
        ...
        boolean res = questionBankQuestionService.remove(queryWrapper);
    ...
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> addQuestionBankQuestionByBatch(
        @RequestBody QuestionBankQuestionBatchAddRequest addBatchRequest, HttpServletRequest request
    ) {
        ThrowUtils.throwIf(addBatchRequest == null, ErrorCode.PARAMS_ERROR);
        Long questionBankId = addBatchRequest.getQuestionBankId();
        List<Long> questionIdList = addBatchRequest.getQuestionIdList();
        User loginUser = userService.getLoginUser(request);
        questionBankQuestionService.addQuestionsToBankByBatch(questionIdList, questionBankId, loginUser);
        return ResultUtils.success(true);
    }
    ...
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> removeQuestionBankQuestionByBatch(
            @RequestBody QuestionBankQuestionBatchRemoveRequest removeBatchRequest
    ) {
        ThrowUtils.throwIf(removeBatchRequest == null, ErrorCode.PARAMS_ERROR);
        Long questionBankId = removeBatchRequest.getQuestionBankId();
        List<Long> questionIdList = removeBatchRequest.getQuestionIdList();
        questionBankQuestionService.removeQuestionsFromBankByBatch(questionIdList, questionBankId);
        return ResultUtils.success(true);
    }
    // endregion
}
